    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="${createLink(controller: "page", action: "homePage")}" class="scroll">Back to home page</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <form role="form" name="ajax-form" id="ajax-form"
                            ...
                            <p class="text-left">What services do you Perform? Please check all that apply.
                            </p>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox1" value="Lock Changes"> Lock Changes
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox2" value="Repair/Rehab"> Repair/Rehab
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox3" value="Electrical"> Electrical
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox4" value="Board ups"> Board ups
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox5" value="FHA Conveyance Work"> FHA Conveyance Work
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox6" value="Plumbing"> Plumbing
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox7" value="Dry/Wet Winterizations"> Dry/Wet Winterizations
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox8" value="Debris Removal"> Debris Removal
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox9" value="HVAC"> HVAC
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox10" value="Lawn Service"> Lawn Service
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox11" value="Roof repair/Tarping"> Roof repair/Tarping
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox12" value="Construction"> Construction
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox13" value="Eviction"> Eviction
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox14" value="Initial Services"> Initial Services
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox15" value="Other"> Other
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox16" value="Pool Services"> Pool Services
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox17" value="Mold Remediation"> Mold Remediation
                                </label>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox18" value="Other"> Other
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="years-experience" class="col-sm-3 control-label">Number of years experience in field:</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="insurance-company" placeholder="Insurance company">
                                </div>
                                <label for="Policy-exp-date" class="col-sm-2 control-label">Policy exp date:</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="Policy-exp-date" placeholder="mm/dd/yyyy">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="Checkbox3" value="Errors and Omissions"> Errors and Omissions
                                </label>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="checkbox-inline">
                            ...
                            <div class="form-group col-sm-6">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="Checkbox5" value="Commercial Auto Policy"> Commercial Auto Policy
                                </label>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="checkbox-inline">
                            ...
                            <div class="form-group col-sm-12">
                                <input class="form-control" id="name2" name="name" placeholder="Business Name" type="text"
                                       value="">

                                <div class="error" id="err-name" style="display: none;">Please enter Business Name</div>
                            </div>
                            <div class="form-group col-sm-12">
                                <input class="form-control" id="contactperson" name="contactperson" placeholder="Contact Person" type="text"
                                       value="">

                                <div class="error" id="err-person" style="display: none;">Please enter Contact Person</div>
                            </div>
                            <div class="form-group col-sm-12">
                            ...
                            <div class="form-group col-sm-12">
                                <input class="form-control" id="Office-phone" name="Office-phone" placeholder="Office Phone" type="text"
                                       value="">
                                <div class="error" id="err-Office-phone" style="display: none;">Please enter Office Phone</div>
                            </div>
                            <div class="form-group col-sm-12">
                                <input class="form-control" id="Cell-phone" name="Cell-phone" placeholder="Cell Phone" type="text"
                                       value="">

                                <div class="error" id="err-Cell-phone" style="display: none;">Please enter Cell Phone</div>
                            </div>
                            <div class="form-group col-sm-12">
                            ...
                            <div class="form-group col-sm-6">
                                <input class="form-control" id="contact-person" name="contact-person" placeholder="Contact Person" type="text"
                                       value="">
                            ...
                            <div class="form-group col-sm-6">
                                <input class="form-control" id="company-name" name="company-name" placeholder="Company Name" type="text"
                                       value="">
                                <div class="error" id="err-company-name" style="display: none;">Please enter Company Name</div>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                <input class="form-control" id="contact-person2" name="contact-person" placeholder="Contact Person" type="text"
                                       value="">
                                <div class="error" id="err-contactperson2" style="display: none;">Please enter Contact Person</div>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                <input class="form-control" id="company-name2" name="company-name" placeholder="Company Name" type="text"
                                       value="">
                                <div class="error" id="err-company-name2" style="display: none;">Please enter Company Name</div>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                <input class="form-control" id="contact-person3" name="contact-person" placeholder="Contact Person" type="text"
                                       value="">
                                <div class="error" id="err-contactperson3" style="display: none;">Please enter Contact Person</div>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                <input class="form-control" id="company-name3" name="company-name" placeholder="Company Name" type="text"
                                       value="">
                                <div class="error" id="err-company-name3" style="display: none;">Please enter Company Name</div>
                            </div>
